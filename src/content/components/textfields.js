...
export default function ContentTextFields() {
  ...
  const propSchema = {
    id: { type: 'string', default: 'demo-textfield' },
    label: { type: 'string', default: 'Name' },
    placeholder: { type: 'string', default: 'Enter your name' },
    value: { type: 'string', default: '', label: 'Value' },
    variant: { type: 'enum', options: ['attached', 'separated', 'stacked'], default: 'separated' },
    labelType: { type: 'enum', options: ['text', 'icon'], default: 'text' },
